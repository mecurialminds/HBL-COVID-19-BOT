...
function WebLiveChatListener() {
	...
	this.createBox = function() {
		...
		if (this.color != null) {
			buttonstyle = "background-color:#008269;";
		}
		if (this.hoverColor != null) {
			buttonHoverStyle = "background-color:#008269;";
		}
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "box { position:fixed;" + boxloc + ";z-index:152;margin:2px;display:none; box-shadow: 1px 5px 19px #808080;	-webkit-border-top-left-radius: 15px;-webkit-border-top-right-radius: 15px;-moz-border-radius-topleft: 15px;-moz-border-radius-topright: 15px;border-top-left-radius: 15px;border-top-right-radius: 15px;}\n"
				...
				+ (this.forceStyles ? "#" : ".") + this.prefix + "chat { width:84.5%;min-height:38px; }\n"
				...
				+ "." + this.prefix + "scroller { overflow-x:hidden;height:420px;width:383px; }\n"
		...
		html = html
			...
			+ "<div id='" + this.prefix + "box' class='" + this.prefix + "box' " + backgroundstyle + '>'
				+ "<div class='" + this.prefix + "boxmenu'>"
					...
					+ '<span> <a id="botplatformchatsendAttachment" class="botplatformchatmenuitem" onclick="return false;" href="#"><img class="botplatformchatmenu" src="https://i.imgur.com/XCbZtPg.png" title="Send an image or file attachment"> </a> </span>'
					+ '<span><a id="botplatformchattoggleChime" class="botplatformchatmenuitem" onclick="return false;" href="#"><img id="boxchime" class="botplatformchatmenu" src="https://i.imgur.com/cuUpv0S.png" title="Play a chime when a message is recieved"></a> </span>'
					+ '<span> <a id="botplatformchattoggleListen" class="botplatformchatmenuitem" onclick="return false;" href="#"><img id="boxmic" class="botplatformchatmenu" src="https://i.imgur.com/EG7TVPr.png" title="Enable speech recognition (browser must support HTML5 speech recognition, such as Chrome)"></a> </span>'
					+ "<span style='float:right'><a id='" + this.prefix + "boxmin' class='" + this.prefix + "boxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/tM3UJw6.png'></a>";
					if (this.showBoxmax) {
		...
		html = html
			...
			if (this.showMenubar) /*{
				...
				html = html
					+ "<tr class='" + this.prefix + "menuitem'>"
						+ "<td><a id='" + this.prefix + "toggleChime' class='" + this.prefix + "menuitem' onclick='return false;' href='#'><img id='boxchime' class='" + this.prefix + "menu' src='https://i.imgur.com/cuUpv0S.png' title='" + SDK.translate("Play a chime when a message is recieved") + "'> " + SDK.translate("Chime") + "</a></td>"
					+ "</tr>\n"
					+ "<tr class='" + this.prefix + "menuitem'>"
					...
					+ "<tr class='" + this.prefix + "menuitem'>"
						+ "<td><a id='" + this.prefix + "toggleListen' class='" + this.prefix + "menuitem' onclick='return false;' href='#'>"
								+ "<img id='boxmic' class='" + this.prefix + "menu' src='https://i.imgur.com/EG7TVPr.png' title='" + SDK.translate("Enable speech recognition (browser must support HTML5 speech recognition, such as Chrome)") + "'> " + SDK.translate("Speech recognition") + "</a>"
						+ "</td>"
					+ "</tr>\n"
					+ "<tr class='" + this.prefix + "menuitem'>"
		...
		html = html
			+ "<td><span class='" + this.prefix + "box-input-span'><input id='" + this.prefix
				+ "chat' type='text' id='" + this.prefix + "box-input' placeholder='Ask me Something...'"
				+ "class='" + this.prefix + "box-input'/><button class='btn-send' id='sendmessagebtn' onclick='return false;'></button></span></td>"
			+ "</tr></table>"
			+ "</div>\n"
			+ "</div>\n"
		...
		if (this.promptContactInfo) {
			html = html
				+ "<div id='" + this.prefix + "contactinfo' class='" + this.prefix + "box' " + backgroundstyle + ">"
					+ "<div class='" + this.prefix + "boxmenu'>"
						+ "<span style='float:right'><a id='" + this.prefix + "contactboxmin' class='" + this.prefix + "contactboxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/tM3UJw6.png'></a>"
					+ "</div>\n"
		...
		if (this.promptEmailChatLog) {
			html = html
				+ "<div id='" + this.prefix + "emailchatlogdialog' class='" + this.prefix + "box' " + backgroundstyle + ">"
					+ "<div class='" + this.prefix + "boxmenu'>"
						+ "<span style='float:right'><a id='" + this.prefix + "emailchatlogdialogmin' class='" + this.prefix + "boxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/tM3UJw6.png'></a>"
					+ "</div>\n"
		...
		if (document.getElementById(this.prefix + "toggleChime") != null) {
			document.getElementById(this.prefix + "toggleChime").addEventListener("click", function() {
				self.toggleChime();
				if (self.playChime) {
					document.getElementById('boxchime').src = "https://i.imgur.com/cuUpv0S.png";
				} else {
					document.getElementById('boxchime').src = "https://i.imgur.com/r9JKnC3.png";
				}
			});
		}
		...
		if (document.getElementById(this.prefix + "toggleListen") != null) {
			document.getElementById(this.prefix + "toggleListen").addEventListener("click", function() {
				...
				if (listen) {
					SDK.startSpeechRecognition();
					document.getElementById('boxmic').src = "https://i.imgur.com/mS1JCU3.png";
				} else {
					SDK.stopSpeechRecognition();
					document.getElementById('boxmic').src = "https://i.imgur.com/EG7TVPr.png";
				}
				return false;
			});
		}
	...
	this.message = function(message) {
		...
		if (this.chatLog) {
			...
			var divNew = '<div style="float:left; padding-left:10px;"><img height="40" width="40" alt="Smiley face" src="https://icon-library.net/images/small-icon-png/small-icon-png-22.jpg"></div>';
			tr.appendChild(td);
			tr.appendChild(td2);
...
function WebChatbotListener() {
	...
	this.createBox = function() {
		...
		var boxloc = "bottom:6px;right:22px";
		if (this.boxLocation == "top-left") {
			boxloc = "top:10px;left:10px";
		} else if (this.boxLocation == "top-right") {
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "box { position:fixed;" + boxloc + ";z-index:152;margin:2px;display:none;border:0px; box-shadow: 1px 5px 19px #808080;	-webkit-border-top-left-radius: 15px;-webkit-border-top-right-radius: 15px;-moz-border-radius-topleft: 15px;-moz-border-radius-topright: 15px;border-top-left-radius: 15px;border-top-right-radius: 15px;}\n"
				+ "." + this.prefix + "boxmenu { visibility:" + hidden + "; }\n"
				+ (this.forceStyles ? "#" : ".") + "" + this.prefix + "boxbarmax { font-size:18px;margin:2px;padding:0px;text-decoration:none; }\n"
				+ "." + this.prefix + "boxbar { position:fixed;" + boxbarloc + ";z-index:152;margin:0;padding:6px;" + buttonstyle + " }\n"
				+ "." + this.prefix + "boxbar:hover { " + buttonHoverStyle + " }\n"
		...
		if (this.version < 6.0 || this.prefix != "botplatform") {
			html = html
				...
				+ "." + this.prefix + "box:hover ." + this.prefix + "boxmenu { visibility:visible; }\n"
				+ "." + this.prefix + "boxclose, ." + this.prefix + "boxmin, ." + this.prefix + "boxmax { font-size:22px;margin:2px;padding:0px;text-decoration:none; }\n"
				+ "." + this.prefix + "boxclose:hover, ." + this.prefix + "boxmin:hover, ." + this.prefix + "boxmax:hover { color: #fff; }\n"
		...
		html = html + this.style
			...
			+ "<div id='" + this.prefix + "box' class='" + this.prefix + "box' " + backgroundstyle + ">"
				+ "<div class='" + this.prefix + "boxmenu'>"
				+'<span style="float:left;padding-right: 263px;" class="botplatformuser-bot"><h2>HBL</h2></span><span style="" class="botplatformuser-bot"><a "botplatformspeechbutton"="" onclick="return false;" href="#" title="Speech"><img id="botplatformboxspeak" class="botplatformboxbutton" src="https://i.imgur.com/quJkEWx.png"></a></span>' 
					+ (this.backlink ? "<span class='" + this.prefix + "chatpowered'>powered by <a href='" + SDK.backlinkURL + "' target='_blank'>" + SDK.NAME + "</a></span>" : "")
					+ "<span style='float:right;  padding-top:4px; padding-right:11px;'><a id='" + this.prefix + "boxmin' class='" + this.prefix + "boxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/58zLTRm.png?1'></a> ";
		if (this.showBoxmax) {
			//html = html + "<a id='" + this.prefix + "boxmax' class='" + this.prefix + "boxmax' onclick='return false;' href='#'><img src='" + SDK.url + "/images/open.png'> </a></span><br/>";
		} else {
			html = html + "</span><br/>";
		...
		html = html
				+ "<div>"
					...
					+ "</div></div></div>"
					+ "<div><span class='" + this.prefix + "box-input-span'><input id='" + this.prefix + "chat' type='text' class='" + this.prefix + "box-input' placeholder='Ask me Something...'/><button class='btn-send' id='sendmessagebtn' onclick='return false;'></button></span></div>";
		if (this.showMenubar) {
			html = html
				...
				if (this.showSendImage) {
					html = html
						...
						+ "<tr id='" + this.prefix + "sendAttachmentMenu' class='" + this.prefix + "menuitem'>"
							+ "<td><a id='" + this.prefix + "sendAttachment' class='" + this.prefix + "menuitem' onclick='return false;' href='#'><img class='" + this.prefix + "menu' src='https://i.imgur.com/XCbZtPg.png' title='Send an image or file attachment'> " + SDK.translate("Send file") + "</a></td>"
						+ "</tr>\n";
				}
			}
			html = html
			...
			if (this.allowSpeech) {
				html = html
					+ "<tr id='" + this.prefix + "speechMenu' class='" + this.prefix + "menuitem'>"
						+ "<td><a id='" + this.prefix + "boxspeakmenu' class='" + this.prefix + "menuitem' onclick='return false;' href='#'><img id='" + this.prefix + "boxspeak2' class='" + this.prefix + "menu' src='"  + (this.speak ? "https://i.imgur.com/cuUpv0S.png": "https://i.imgur.com/r9JKnC3.png") +"' title='Speech'> " + SDK.translate("Speech") + "</a></td>"
					+ "</tr>\n";
			}
				...
				html = html
					+ "<tr id='" + this.prefix + "speechRecognitionMenu' class='" + this.prefix + "menuitem'>"
						+ "<td><a id='" + this.prefix + "boxspeakrecognitionmenu' class='" + this.prefix + "menuitem' onclick='return false;' href='#'>"
								+ "<img id='" + this.prefix + "boxspeakrecognition2' class='" + this.prefix + "menu' src='https://i.imgur.com/EG7TVPr.png' title='Speech recognition (browser must support HTML5 speech recognition, such as Chrome)'> " + SDK.translate("Speech Recognition") + "</a>"
						+ "</td>"
					+ "</tr>\n";
			}
			html = html
			...
			if (this.allowSpeech) {
				html = html
					+ "<a '" + this.prefix + "speechButton' onclick='return false;' href='#' title='Speech'><img id='" + this.prefix + "boxspeak' class='" + this.prefix + "boxbutton' src='"
									...
									+ (this.speak ? "https://i.imgur.com/cuUpv0S.png": "https://i.imgur.com/r9JKnC3.png") +"'></a></td>";
			}
			if (this.allowSpeechRecognition == true || (this.allowSpeechRecognition == null && this.allowSpeech && SDK.isChrome())) {
				html = html
		...
		if (this.allowFiles && this.showFileButtons) {
			html = html
				...
				+ "<a id='" + this.prefix + "sendAttachmentTool' onclick='return false;' href='#'><img class='" + this.prefix + "boxbutton' src='https://i.imgur.com/XCbZtPg.png' title='Send an image or file attachment'></a>";
		}
		html = html
			+ "</span>"
			+ "</div>"
		...
		if (this.promptContactInfo) {
			html = html
				+ "<div id='" + this.prefix + "contactinfo' class='" + this.prefix + "box' " + backgroundstyle + ">"
					+ "<div class='" + this.prefix + "boxmenu'>"
						+ "<span style='float:right; padding-top:9px; padding-right:4px;'><a id='" + this.prefix + "contactboxmin' class='" + this.prefix + "contactboxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/58zLTRm.png?1'></a>"
					+ "</div>\n"
					+ "<div style='margin:10px'>\n"
						+ "<span>" + SDK.translate("Name") + "</span><br/><input id='" + this.prefix + "contactname' type='text' /><br/>\n"
						+ "<span>" + SDK.translate("Email") + "</span><br/><input id='" + this.prefix + "contactemail' type='email' /><br/>\n"
		...
		if (document.getElementById(this.prefix + "boxspeakrecognition") != null) {
			...
			document.getElementById(this.prefix + "boxspeakrecognitionmenu").addEventListener("click", function() {
				...
				if (self.listen) {
					SDK.startSpeechRecognition();
					document.getElementById(self.prefix + 'boxspeakrecognition').src = "https://i.imgur.com/mS1JCU3.png"; //micon
					document.getElementById(self.prefix + 'boxspeakrecognition2').src = "https://i.imgur.com/mS1JCU3.png";//micon
				} else {
					SDK.stopSpeechRecognition();
					document.getElementById(self.prefix + 'boxspeakrecognition').src = "https://i.imgur.com/EG7TVPr.png"; //micoff
					document.getElementById(self.prefix + 'boxspeakrecognition2').src = "https://i.imgur.com/EG7TVPr.png";//micoff
				}
			});
		}
	}
	...
	this.message = function(user, message) {
		...
		var date = new Date(); 
		//var imgDiv = '<div style="float:left; padding-left:5px;"> <img height="40" width="40" alt="Smiley face" src="https://icon-library.net/images/small-icon-png/small-icon-png-22.jpg"> </div>';
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				...
				+ "#" + this.prefix + "avatarboxclose:hover { color: #fff }\n"
			+ "</style>\n"
